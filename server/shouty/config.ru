require './application'
Shouty::Application.initialize!

# Development middlewares
if Shouty::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Shouty::Application.root(:public)
end
